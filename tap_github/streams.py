...
class FullTableGithubStream(GithubStream):
    def sync_endpoint(
        self,
        client,
        state,
...
class IncrementalGithubStream(GithubStream):
    def sync_endpoint(
        self,
        client,
        state,
...
class IncrementalOrderedGithubStream(GithubStream):
...
class Reviews(IncrementalGithubStream):
    """
...
class ReviewComments(IncrementalOrderedGithubStream):
    """
...
class PRCommits(IncrementalGithubStream):
    """
...
class PullRequests(IncrementalOrderedGithubStream):
    """
...
class ProjectCards(IncrementalGithubStream):
    """
...
class ProjectColumns(IncrementalGithubStream):
    """
...
class Projects(IncrementalGithubStream):
    """
...
class TeamMemberships(FullTableGithubStream):
    """
...
class TeamMembers(FullTableGithubStream):
    """
...
class Teams(FullTableGithubStream):
    """
...
class Comments(IncrementalOrderedGithubStream):
    """
...
class Issues(IncrementalOrderedGithubStream):
    """
...
class Assignees(FullTableGithubStream):
    """
...
class Releases(FullTableGithubStream):
    """
...
class IssueLabels(FullTableGithubStream):
    """
...
class IssueEvents(IncrementalOrderedGithubStream):
    """
...
class Events(IncrementalGithubStream):
    """
...
class CommitComments(IncrementalGithubStream):
    """
...
class IssueMilestones(IncrementalOrderedGithubStream):
    """
...
class Collaborators(FullTableGithubStream):
    """
...
class StarGazers(FullTableGithubStream):
    """
